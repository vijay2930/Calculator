...
public class CalculatorView implements CalculatorViewCallBack{
    private CalculatorControllerViewCallBack calculatorController;
    ...
    private void getHistory() {
        ...
        calculatorController.getMyHistory(userName,date);
    }
    ...
    private void getComputeValue() {
        ...
        calculatorController.getResult(userName,exp);
