...
public class CalculatorModel implements CalculatorModelCallBack{
    private CalculatorControllerModelCallBack calculatorController;
    ...
    public void getMyHistory(String userName, String date) {
        ...
        if(expressionList==null){
            calculatorController.getMyHistoryFailed("No match found for the given date");
        }else {
            calculatorController.getMyHistorySuccessfully(expressionList);
        }
    }
    ...
    public void evaluate(String username,String expression) {
        ...
        for (int i = 0; i < expression.length(); i++) {
            ...
            if(isNotAValidSymbol(c)){
                ...
                calculatorController.getResultFailed("InValid Expression.");
            }
        ...
        calculatorController.getResultSuccessfull(res);
    }
